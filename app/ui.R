                   ...
                   "Genre Observations", sidebarLayout(
                       ...
                       mainPanel(
                           ...
                           p(strong("Description:"), "The data table displayed shows the relationship between all the relevant variables of total earnings and
                             ...
                             genre is also supplied with many various titled games in the desired genre category. A summary is also provided and changes
                             each time an individual genre is selected, where the summary will provide information on the max you can observe (length), ")
                       )
                   )
               ),
               ## -------------------------------------
